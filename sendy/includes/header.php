...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo get_app_info('path');?>/css/bootstrap.css?2" />
	    ...
	    <![endif]-->
		<link rel="stylesheet" type="text/css" href="<?php echo get_app_info('path');?>/css/all.css?2" />
