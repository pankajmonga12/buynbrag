...
<?php
	if(get_app_info('is_sub_user')) 
	{
		...
		{
			echo '<script type="text/javascript">window.location="'.get_app_info('path').'/autoresponders-edit?i='.get_app_info('restricted_to_app').'&a='.$_GET['a'].'&ae='.$_GET['ae'].'"</script>';
			exit;
		}
	}
	$edit = true;
				    ...
				    ?>
									<ul id="attachments">
										<li id="attachment<?php echo $i;?>">
											...
											<a href="<?php echo get_app_info('path');?>/includes/ares/delete-attachment.php" data-filename="<?php echo $file;?>" title="Delete" id="delete<?php echo $i;?>"><i class="icon icon-trash"></i></a>
											<script type="text/javascript">
