				...
				<div class="bannerMid">
					...
					<div
						class="badgesContainer"> <?php if (isset($badges)): if (count($badges) > 3) $n = 3; else $n = count($badges);
							...
							<div class="pinkBadge"><a href="<?php echo $base_url . '#/badges/' . $uid; ?>">
				...
				<div class="rightPanel">
					...
					<div class="FriendsContainer">
						...
						<div
							...
							for ($i = 0; $i < $n; $i++)
							{
								$friendsImageSrc = (strcmp($friends[$i]['fb_uid'], "non-fb-member") === 0)? $baseURL."assets/images/default/".((strcmp($friends[$i]['gender'], "female") === 0)? "female": "male").".png": "https://graph.facebook.com/".$friends[$i]['fb_uid']."/picture?width=200&height=200";
							?>
								<a href="<?php echo $base_url . 'order/friend_fancy_product/' . $friends[$i]['user_id'] ?>">
									<div class="prodBg">
									<img src="<?php echo $friendsImageSrc; ?>" width="60" height="60"/>
									</div>
								</a>
							<?php
							}
					...
					<div class="FriendsContainer">
						...
						<div
							...
							for ($i = 0; $i < $n; $i++)
							{
								$followersImageSrc = (strcmp($followers[$i]['fb_uid'], "non-fb-member") === 0)? $baseURL."assets/images/default/".((strcmp($followers[$i]['gender'], "female") === 0)? "female": "male").".png": "https://graph.facebook.com/".$followers[$i]['fb_uid']."/picture?width=200&height=200";
							?>
								<a href="<?php echo $base_url . 'order/friend_fancy_product/' . $followers[$i]['user_id'] ?>">
									<div class="prodBg">
										<img src="<?php echo $followersImageSrc; ?>" width="62" height="62"/>
									</div>
								</a>
							<?php 
							}
					...
					<div class="FriendsContainer">
						...
						<div
							...
							for ($i = 0; $i < $n; $i++)
							{
								$followeesImageSrc = (strcmp($followees[$i]['fb_uid'], "non-fb-member") === 0)? $baseURL."assets/images/default/".((strcmp($followees[$i]['gender'], "female") === 0)? "female": "male").".png": "https://graph.facebook.com/".$followees[$i]['fb_uid']."/picture?width=200&height=200";
							?>
								<a href="<?php echo $base_url . 'order/friend_fancy_product/' . $followees[$i]['user_id'] ?>">
									<div class="prodBg">
										<img src="<?php echo $followeesImageSrc; ?>" width="62" height="62"/>
									</div>
								</a>
							<?php
							}
