...
<div class="container"> <!-- Main hero unit for a primary marketing message or call to action -->
	<div class="hero-unit"
	     style="margin-top: 20px; color: #fff; background-image:url(<?php echo image("media/jolly.jpg", "hero"); ?>);">
		...
		<p><a class="btn primary large">Learn more &raquo;</a></p></div>
	<!-- Example row of columns -->
	<div class="row">
		<div class="span6"><h2>Medium</h2> <img
				src="<?php echo image("http://localhost/fork/BuynBrag/media/street.jpg", "medium"); ?>"/>

			<p>Etiam porta sem malesuada magna mollis euismod. Integer posuere erat a ante venenatis dapibus posuere
				velit aliquet. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Duis
				mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</p>

			<p><a class="btn" href="#">View details &raquo;</a></p></div>
		<div class="span5"><h2>Small</h2> <img src="<?php echo image("media/clouds.jpg", "small"); ?>"/>
			...
			<p><a class="btn" href="#">View details &raquo;</a></p></div>
		<div class="span5"><h2>Long</h2> <img src="<?php echo image("media/dopeshow.jpg", "long"); ?>"/>
