		...
		<div class="FancyPopupActual">
			...
			<div class="leftRightPop">
				<div class="leftPop fl">
					<div class="ImageHolder"><img id="f_img" width="322" height="243"/>
						...
						<div class="fl">
							<div class="storeDecoratingText myProductName">&nbsp;</div>
							<div class="storeDecoratingText font12 myStoreName">&nbsp;</div>
							<div class="storeFancyHolder">
								<div class="fanciedIcon"></div>
								<div
									class="fancyNumber storeExtraStyle"><?php echo $products[0]->fancy_counter; ?></div>
...
<div class="FancyPopupContainer" id="EditPopupContainer">
	<div class="FancyPopupWrapper">
		...
		<div class="FancyPopupActual">
			...
			<div class="leftRightPop">
				<div class="leftPop fl">
					<div class="ImageHolder"><img id="uf_img" width="322" height="243"/>
