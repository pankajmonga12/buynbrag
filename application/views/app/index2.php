...
<!--    <meta name="fragment" content="!" />-->
    <base href="/application/views/app/index.php">
...
<body class="scrollingActive lightBg {{bodyClass}}" prefetch-templates>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container">
                ...
                <h1 class="logoHeading">
                    <a class="logo pull-left hidden-phone" href="/application/views/app/">
                ...
                <div class="signedInProfileHolder pull-right" ng-show="user.userid">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="profile/social/{{user.userid}}">Profile</a></li>
                        <li><a href="profile/fancy/{{user.userid}}">Brag list<span class="dropDownBadge pull-right hidden-desktop">{{user.userdata.fancy}}</span></a></li>
                        <li><a href="profile/badges/{{user.userid}}">Badges unlocked<span class="dropDownBadge pull-right hidden-desktop">{{user.userdata.totalBadges}}</span></a></li>
                        <li><a href="" ng-click="openModal('couponsModal')" role="button" data-toggle="modal">Coupons available</a></li>
                ...
                <div class="nav-collapse">
                    ...
                    <ul class="nav">
                        ...
                        <li class="relative">
                            ...
                            <ul class="dropdown-menu visible-iphone-landscape" style="height: 0; overflow: hidden;">
...
<div ng-switch="subview">
    ...
    <div ng-switch-when="profileHeader">
        <div ng-include=" '/application/views/app/src/app/pages/profile/profileHeader.html' ">
...
<!-- USER COUPONS Modal -->
<div id="couponsModal" url="/application/views/app/src/app/exhaustiveFeatures/independentModals/coupons/coupons.html" dynamic-modal class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" ng-controller="CouponsController"></div>
...
<!-- Fancy List Modal -->
<div id="fancyListModal" url="/application/views/app/src/app/exhaustiveFeatures/callToActions/brag/bragList.html" dynamic-modal class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" fancy-list></div>

<!-- Tag User modal -->
<div id="tagFriendModal" url="/application/views/app/src/app/exhaustiveFeatures/callToActions/tag/tagUser.html" dynamic-modal class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" tag-friends></div>

<!-- Fancied By modal -->
<div id="prodBraggedUserModal" url="/application/views/app/src/app/exhaustiveFeatures/independentModals/fanciedBy/usersList.html" dynamic-modal  class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" userswhobragged></div>
...
<!--Addthis code-->
<!--<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-52230be844baaf4d"></script>-->
<!--<script type="text/javascript">-->
    <!--var addthis_config = {-->
        ...
        <!--data_ga_social : true,-->
        <!--ervices_expanded : 'facebook,twitter,google_plusone_share,pinterest,email',-->
...
<script id="_webengage_script_tag" type="text/javascript">
  var _weq = _weq || {};
  _weq['webengage.licenseCode'] = '~15ba20aad';
