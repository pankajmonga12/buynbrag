<?php $this->load->database(); $this->load->model('friends_follow_model'); ?>
<!doctype html>
  ...
  <article class="banner">
        ...
        <nav class="middleColumnTop">
            ...
            <div class="linksMiddle">
                ...
                <a href=""><div class="productsLink">
                    <div class="inviteLogo2"></div>
                    <div class="productsText newPadding">Invite People</div>
                </div></a>
                <a href=""><div class="purchaseHistory">
            
                    <div class="purchaseText1"><span class="pink"><?php echo count($followers);?></span> Followers</div>
                     <div class="purchaseText1"><span class="pink"><?php echo count($followees);?></span> Following</div>
    			</div></a>
            </div> 
	  ...
	  <?php foreach($followees as $fullon)
	  {
	        $user_id=$fullon['user_id'];
		   
	  ?>
	  
      <div class="follow_pad">
      <div class="follow_img">
      <a href="<?php echo base_url(); ?>order/friend_fancy_product/<?php echo $user_id;?>"><img src="<?php echo base_url();?>assets/images/users/<?php echo $user_id; ?>/<?php echo $user_id; ?>.jpg"/></a>
      </div>
      <div class="follow_side">
      <div style="overflow:hidden;">
      <div class="follow_text">
      <h2><?php print $fullon['full_name'];?></h2>
      <div class="follow_t"><?php $count_followers=$this->search_model->count_followers($user_id); print $count_followers; ?> Followers &nbsp;<?php $count_following=$this->search_model->get_followees($user_id); print $count_following; ?> Following </div>
