		...
		<div class="FancyPopupActual">
			...
			<div class="leftRightPop">
				<div class="leftPop fl">
					<div class="ImageHolder"><img width="322" height="313" id="f_img"/>
						...
						<!-- <div class="fl"> <div class="storeDecoratingText"><?php //echo $fprodU[0]->product_name; ?></div> <div class="storeDecoratingText font12"><?php //echo $fprodU[0]->product_name; ?></div> <div class="storeFancyHolder"> <div class="fanciedIcon"></div> <div class="fancyNumber storeExtraStyle"><?php //echo $fprodU[0]->fancy_counter; ?></div> <div class="fancyText storeExtraStyle">fancied</div> </div> </div> -->
						<!--<div class="priceHolder"><span class="rupee">`</span> <?php //echo intval($fprodU[0]->selling_price); ?></div>-->
					</div>
				</div>
				<div class="rightest">
...
<div class="FancyPopupContainer" id="EditPopupContainer">
	<div class="FancyPopupWrapper">
		...
		<div class="FancyPopupActual">
			...
			<div class="leftRightPop">
				<div class="leftPop fl">
					<div class="ImageHolder"><img width="322" height="313" id="uf_img"/>
						...
						<!-- <div class="fl"> <div class="storeDecoratingText"><?php //echo $fprodU[0]->product_name; ?></div> <div class="storeDecoratingText font12"><?php //echo $fprodU[0]->product_name; ?></div> <div class="storeFancyHolder"> <div class="fanciedIcon"></div> <div class="fancyNumber storeExtraStyle"><?php //echo $fprodU[0]->fancy_counter; ?></div> <div class="fancyText storeExtraStyle">fancied</div> </div> </div> <div class="priceHolder"><span class="rupee">`</span> <?php //echo intval($fprodU[0]->selling_price); ?></div>-->
					</div>
				</div>
				<div class="rightest">
