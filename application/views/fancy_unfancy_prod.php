			...
			<div class="leftRightPop">
				<div class="leftPop fl">
					<div class="ImageHolder"><img id="f_img" width="322" height="313"/>
						...
						<!-- <div class="fl"> <div class="storeDecoratingText"><?php //echo $fprod[0]->product_name; ?></div> <div class="storeDecoratingText font12"><?php //echo $fprod[0]->product_name; ?></div> <div class="storeFancyHolder"> <div class="fanciedIcon"></div> <div class="fancyNumber storeExtraStyle"><?php //echo $fprod[0]->fancy_counter; ?></div> <div class="fancyText storeExtraStyle">fancied</div> </div> </div> -->
						<!--<div class="priceHolder"><span class="rupee">`</span> <?php //echo intval($fprod[0]->selling_price); ?></div>-->
					</div>
				</div>
				<div class="rightest">
			...
			<div class="leftRightPop">
				<div class="leftPop fl">
					<div class="ImageHolder"><img id="uf_img" width="322" height="313"/>
						...
						<!-- <div class="fl"> <div class="storeDecoratingText"><?php //echo $fprod[0]->product_name; ?></div> <div class="storeDecoratingText font12"><?php //echo $fprod[0]->product_name; ?></div> <div class="storeFancyHolder"> <div class="fanciedIcon"></div> <div class="fancyNumber storeExtraStyle"><?php //echo $fprod[0]->fancy_counter; ?></div> <div class="fancyText storeExtraStyle">fancied</div> </div> </div> <div class="priceHolder"><span class="rupee">`</span> <?php //echo intval($fprod[0]->selling_price); ?></div>-->
					</div>
				</div>
				<div class="rightest">
