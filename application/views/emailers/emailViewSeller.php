                            ...
                            <tr>
                                <td style="font:14px/1.4285714 Arial,sans-serif;padding:0">
                                    <div style="background:#fff;border:1px solid #ccc;border-radius:5px;padding:20px">
                                        ...
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            This email is with reference to order no <?php echo $orderid; ?>.</p>
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            We would like to inform you that you have updated the AWB NO for <?php echo $orderid; ?>.</p>
                                        <p style="margin:0;margin-top:15px; margin-bottom: 10px; padding:0">
                                            Meanwhile, if you have any queries about order, just email us at <a href="mailto:ops@buynbrag.com" target="_top">ops@buynbrag.com</a> or give us a call/ text on +91 8130 878 822.</p>
                                        <p style="margin:0;margin-top:15px; margin-bottom: 10px; padding:0">
