                            ...
                            <tr>
                                ...
                                <td style="font:14px/1.4285714 Arial,sans-serif;padding:0">
                                    ...
                                    <div style="background:#fff;border:1px solid #ccc;border-radius:5px;padding:20px">
                                        ...
                                        <h1 style="font:22px/1.4285714 Arial,sans-serif;font-weight:lighter;padding:0;margin:0; margin-bottom:15px;">We are so glad you signed up at <a style="text-decoration:none;" href="http://www.buynbrag.com">BuynBrag.com</a></h1>

                                        Your profile is not complete yet. Please <a href="http://buynbrag.com">login</a> and complete your profile and start discovering, fancying and curating great products!
