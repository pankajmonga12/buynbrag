                                ...
                                <td style="font:14px/1.4285714 Arial,sans-serif;padding:0">
                                    <div style="background:#fff;border:1px solid #ccc;border-radius:5px;padding:20px">
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            Dear <?php echo $buyerName; ?>,</p>
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            This email is with reference to your order <?php echo $orderID; ?>.</p>
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            We would like to confirm that [seller] has rescheduled the shipping date to <?php echo $dispatchDate; ?> for your product <?php echo $productName; ?>.</p>
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            We'll send you another email to confirm when your order has been shipped.</p>
