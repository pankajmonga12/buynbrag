                                ...
                                <td style="font:14px/1.4285714 Arial,sans-serif;padding:0">
                                    <div style="background:#fff;border:1px solid #ccc;border-radius:5px;padding:20px">
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            Dear <?php echo $Customername; ?>,</p>
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            This email is with reference to your order no <?php echo $orderid; ?>.</p>
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            We would like to inform you that your order no <?php echo $orderid; ?> is scheduled for dispatch through <?php echo $shipping_partner; ?> on <?php echo $Estimateddispatchtime; ?> as the seller has updated AWB NO for<?php echo $orderid;?>.AWB NO for your product is <?php echo $awbNo;?>.<br><br>The parcel may be tracked at <?php echo $shipping_partner; ?>'s website.<br>(Note:Online tracking might be delayed and may take up to 24 - 48 hours to be activated)</p>
                                        <p style="margin:0; margin-bottom: 10px; padding:0">
                                            Please inform us, if the parcel is in tampered condition by phone or email.</p>
                                        <p style="margin:0;margin-top:15px; margin-bottom: 10px; padding:0">
                                            Meanwhile, if you have any queries about your order, just email us at <a href="mailto:ops@buynbrag.com" target="_top">ops@buynbrag.com</a> or give us a call/ text on +91 8130 878 822.</p>
                                        <p style="margin:0;margin-top:15px; margin-bottom: 10px; padding:0">
                                        ...
                                        <div style="padding:0;margin:0; margin-top:20px;">
                                                ...
                                                <p style="margin: 0; padding: 0;">Contact no : +91-8130878822</p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
