                                            ...
                                            <tr>
                                                <td style="font:14px/1.4285714 Arial,sans-serif;padding:0">
                                                    <p style="margin-bottom:10px;margin-top:0">
                                                        Hi <strong><?php echo $followeeFullName; ?></strong>,
                                                        <br/><strong><?php echo $followerFullName; ?></strong> just joined <a href="http://buynbrag.com/">BuynBrag</a> and started following your curation.
                                                    </p>
                                                </td>
                                            </tr>
