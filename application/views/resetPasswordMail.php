<div>
                                            ...
                                            <tr>
                                                <td style="font:14px/1.4285714 Arial,sans-serif;padding:0">
                                                    <p style="margin-bottom:0;margin-top:0">
                                                        You're receiving this email because someone from <?php echo $ip; ?> initiated a password reset
                                                        request on <strong>BuynBrag.com</strong>.
                                                    </p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="font:14px/1.4285714 Arial,sans-serif;padding:15px 0 0">
                                                    <table style="width:auto;border-collapse:collapse">
                                                        ...
                                                        <tr>
                                                            <td style="font:14px/1.4285714 Arial,sans-serif;padding:0">
                                                                <div style="border:1px solid #0064bd;border-radius:1px;background:#0069c8;">
                                                                    <table style="width:auto;border-collapse:collapse">
                                                                        <tbody>
                                                                        <tr>
                                                                            <td style="font:14px/1.4285714 Arial,sans-serif;padding:4px 10px">
                                                                                <a href="<?php echo $resetLink; ?>" style="color:white;text-decoration:none;font-weight:bold" target="_blank" wotsearchprocessed="true">Reset password</a>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
                            ...
                            <tr>
                                <td style="font:14px/1.4285714 Arial,sans-serif;padding:20px 0;color:#707070">
                                    <table style="width:100%;border-collapse:collapse">
                                        <tbody>
                                        <tr>
                                            <td style="font:14px/1.4285714 Arial,sans-serif;padding:0"></td>
                                            <td style="font:14px/1.4285714 Arial,sans-serif;padding:0"></td>
    ...
    <div class="yj6qo"></div><div class="yj6qo"></div></div>
