                    ...
                    <div class="bannerMid">
                        ...
                        <div
                            ...
                            if(isset($badges))
                            {
                                ...
                                for ($i = 0; $i < $n; $i++)
                                {
									if($lastBadge == $user_badge[$i]->badge_type)
									{
										$i--;
										continue;
									}
									...
									{
										$lastBadge = $user_badge[$i]->badge_type;
										?>
										<img src="<?php echo $base_url . 'assets/images/badges/' . $badges[$i]['img']?>" class="silverBadge">
										<?php
									}
								}
								?>
								<!-- <div class="goldBadge"></div> <div class="platinumBadge"></div>-->
                                <div class="pinkBadge">
...
<!--                        </a>-->
			...
			if (isset($loop))
			{
				for ($i = 0; $i < $loop; $i++)
				{
					$numbers = range(1, 3);
					shuffle($numbers);
					$numbers = array(0 => 3, 1 => 3, 2 => 3);
					include "flayout" . $numbers[0] . ".php"; 
					include "flayout" . $numbers[1] . ".php";
					include "flayout" . $numbers[2] . ".php";
				}
				
				if ($imgloop == 5)
				{
					/*include 'flayout2.php';*/
					include 'flayout3.php';
				}
				elseif ($imgloop == 4)
				{
					/*include 'flayout2.php';*/
