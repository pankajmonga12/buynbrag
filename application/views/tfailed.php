...
<section class="wrapper">
	<section class="middleBackground">
		<div
			class="topDotSeparator"></div> <?php echo "Transaction Failed. Please Try again!"; //sleep(5); header( "refresh:5;url=http://localhost/CII/index.php/cart/shopping_cart/1" ); //header('Location: http://localhost/CII/index.php/store_page/101'); ?>
	</section>
