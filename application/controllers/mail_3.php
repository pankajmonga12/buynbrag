...
<div style="text-align: center; ">
	...
	<img align="center" height="100px" alt=" " src="' . $base_url . 'assets/images/users/' . $newbie_id . '/' . $newbie_id . '_large.jpg">
	<strong>' . $newbie_name . '</strong> just joined BuynBrag!&nbsp;</span></div>
<div style="text-align: center; ">
	&nbsp;</div>
<a style="text-decoration:none;" href="' . $base_url . 'order/friend_fancy_product/' . $newbie_id . '"><p style="background:#ff8e6b;border:3px solid #ebebeb;width:auto;color:#fff;text-align:center;margin:25px 15%;font-size:40px;font-family:Georgia;padding:.7em 0;">
...
<div class="fb-like" data-href="https://www.facebook.com/Buynbrag" data-send="false" data-layout="button_count" data-width="450" data-show-faces="true" data-font="tahoma"></div>
	</p>
<div style="">
	<div>
