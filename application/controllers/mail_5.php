...
Kindly note down the Transaction ID for any future reference: <font color=blue><br><strong>' . $txnid . '</strong></font><br>
 <br>';
if ($shipping_company != 'GATI')
	$shipped_message = $shipped_message . '
The tracking number for the shipped item is: <font color="red"><br><strong>' . $awb_no . '</strong></font><br>
 <br>
Track your Item here with the provided tracking Number: <br><a style="color:#4682b4;" target="_blank" href="' . $track_link . '">' . $shipping_company . '(Track here)</a><br><br>';
$shipped_message = $shipped_message . '
