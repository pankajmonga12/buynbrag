...
if ($order_details['communication_pincode'] != "NULL")
    ...
    $seller_code = '';
$seller_contact_no = 'Ph: +91-124-44 23999';
...
$this->cezpdf->ezText('<b>We hope you love what you bought! If not, contact our customer care team at +91-124-44 23999</b>', 10);

$this->cezpdf->ezText('', 10);

$this->cezpdf->ezSetCmMargins(2, 4, 6, 1);
$this->cezpdf->ezText('<b>Mon-Sat,10am to 7pm,or email us at " talktous@buynbrag.com "</b>', 10);
