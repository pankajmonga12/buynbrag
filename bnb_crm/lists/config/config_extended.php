...
$database_host = "myolddbtemp.c4xniebqwpch.ap-southeast-1.rds.amazonaws.com";

# what is the name of the database we are using
$database_name = "phpList";

# who do we log in as?
$database_user = "bnbuser";

# and what password do we use
$database_password = '34d04b8745abd3ef7ea88d9ac0637e64';
...
$pageroot = '/bnb_crm/lists';
$adminpages = '/bnb_crm/lists';
...
$message_envelope = 'talktous@buynbrag.com';
...
$phpmailer_smtpuser = 'AKIAIWGOC3JYHQXJHYJA';
$phpmailer_smtppassword = 'Ans0ELSec8JvU7A8kDIHoTReXqdDvxx13wam3xlTosWH';
...
define('PHPMAILERTESTHOST','');
define('PHPMAILERBLASTHOST','');
define('PHPMAILERBLASTPORT', 465);
...
define('UPLOADIMAGES_DIR', __DIR__."/uploadimages");
...
define("FORWARD_PERSONAL_NOTE_SIZE",1);
...
# Added by Shammi for AMAZON SES
define('USE_AMAZONSES',1);

define('AWS_ACCESSKEYID','AKIAIWGOC3JYHQXJHYJA');

define('AWS_SECRETKEY','Ans0ELSec8JvU7A8kDIHoTReXqdDvxx13wam3xlTosWH');

define('AWS_POSTURL','https://email-smtp.us-east-1.amazonaws.com/');
