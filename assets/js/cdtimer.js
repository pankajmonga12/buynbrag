var Timer,
	...
	function UpdateTimer() {
		...
		if(Days > 0)
		{
			TimeStr += '<li><span class="number">' + LeadingZero(Days) + '</span><span>Days</span></li>';
		}
		
		TimeStr += '<li><span class="number">' + LeadingZero(Hours) + '</span><span>Hours</span></li>' + '<li><span class="number">' + LeadingZero(Minutes) + '</span><span>Minutes</span></li>' + '<li><span class="number">' + LeadingZero(Seconds) + '</span><span>Seconds</span></li>';
